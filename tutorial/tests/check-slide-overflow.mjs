 ...
 *   node tutorial/tests/check-slide-overflow.mjs tutorial/slides/ws3-datenmodell-deck.md
 */
...
// Playwright wird global installiert (npm i -g playwright). ESM-Import findet
// globale Module nicht, deshalb gehen wir ueber createRequire + npm-Root.
...
const TOLERANCE_PX = 2; // Browser-Rundung abfangen
